...
db=mysql.connector.connect(user="root",passwd="Bhuvan@9686",host="localhost") 
...
db=mysql.connector.connect(user="root",passwd="Bhuvan@9686",host="localhost",database='Shop') 
my_cursor=db.cursor()
